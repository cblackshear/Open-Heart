...
*Only include participants who have all covariates;
	...
	if missing(currentsmoker) then delete;
...
*For Males;
  ...
  *Framingham Point Scores by Smoking Status; 
  if sex="Male" & currentsmoker=0 then smokescoremen=0;
  if sex="Male" & currentsmoker=1 then smokescoremen=2;
...
*For Females;
  ...
  *Framingham Point Scores by Smoking Status; 
  if sex="Female" & currentsmoker=0 then smokescorefe=0;
  if sex="Female" & currentsmoker=1 then smokescorefe=2;
...
*For Males;
  ...
  *Framingham Point Scores by Smoking Status;
  if sex="Male" & currentsmoker=0 then smokescoremen=0;
  if sex="Male" & currentsmoker=1 then smokescoremen=4;
...
*For Females;
  ...
  *Framingham Point Scores by Smoking Status; 
  if sex="Female" & currentsmoker=0 then smokescorefe=0;
  if sex="Female" & currentsmoker=1 then smokescorefe=3;
...
*For Males;
  ...
  *Creating smoke score;
  if currentsmoker=0 and agecategory=1 then smokescore=1;
  if currentsmoker=0 and agecategory=2 then smokescore=2;
  if currentsmoker=0 and agecategory=3 then smokescore=3;
  if currentsmoker=0 and agecategory=4 then smokescore=4;
  if currentsmoker=0 and agecategory=5 then smokescore=5;

  if currentsmoker=1 and agecategory=1 then smokescore=6;
  if currentsmoker=1 and agecategory=2 then smokescore=7;
  if currentsmoker=1 and agecategory=3 then smokescore=8;
  if currentsmoker=1 and agecategory=4 then smokescore=9;
  if currentsmoker=1 and agecategory=5 then smokescore=10;
...
*Male Covariates;
  ...
  *conditional smoking term;
  if currentsmoker=1 then smoketermen = 0.405;
  if currentsmoker=0 then smoketermen = 0;
...
*Female Covariates;
  ...
  *Interaction terms;
  *conditional smoking term;
  if currentsmoker=1 then smoketermwmn = 0.818;
  if currentsmoker=0 then smoketermwmn = 0;
