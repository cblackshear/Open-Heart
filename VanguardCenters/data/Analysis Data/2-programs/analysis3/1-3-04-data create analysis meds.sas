...
*MSRC;
data include2; *MSRC;
  set jhsV3.msrc(keep = subjid msrc2 msrc29a msrc29b msrc29c msrc29d msrc29e msrc29f msrc29g msrc29h msrc29i); 
  by subjid;

  *Create renamed duplicates for formulas;
  BPmedsSelfRep           = msrc29a;
  statinMedsSelfRep       = msrc29b;
  *anginaMedsSelfRep       = msrc29c;
  antiArythMedsSelfRep    = msrc29d;
  *HFmedsSelfRep           = msrc29e;
  *bloodThinnerMedsSelfRep = msrc29f;
  dmMedsSelfRep           = msrc29g;
  *strokeMedsSelfRep       = msrc29h;
  *legPainMedsSelfRep      = msrc29i;
