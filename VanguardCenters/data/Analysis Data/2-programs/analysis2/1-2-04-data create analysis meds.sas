...
*MSRB;
data include2; *MSRB;
  set jhsV2.msrb(keep = subjid msrb2 msrb29a msrb29b msrb29c msrb29d msrb29e msrb29f msrb29g msrb29h msrb29i); 
  by subjid;

  *Create renamed duplicates for formulas;
  BPmedsSelfRep           = msrb29a;
  statinMedsSelfRep       = msrb29b;
  *anginaMedsSelfRep       = msrb29c;
  antiArythMedsSelfRep    = msrb29d;
  *HFmedsSelfRep           = msrb29e;
  *bloodThinnerMedsSelfRep = msrb29f;
  dmMedsSelfRep           = msrb29g;
  *strokeMedsSelfRep       = msrb29h;
  *legPainMedsSelfRep      = msrb29i;
...
data include; *Create Variables;
  ...
  *Variable: BPmedsSelf;
  BPmedsSelf = .;
  if BPmedsSelfRep = 2 then BPmedsSelf = 0;
  if BPmedsSelfRep = 1 then BPmedsSelf = 1;
  ...
  *Variable: dmMedsSelf;
  dmMedsSelf = .;
  if dmMedsSelfRep = 2 then dmMedsSelf = 0;
  if dmMedsSelfRep = 1 then dmMedsSelf = 1;
  ...
  *Variable: statinMedsSelf;
  statinMedsSelf = .;
  if statinMedsSelfRep = 2 then statinMedsSelf = 0;
  if statinMedsSelfRep = 1 then statinMedsSelf = 1;
  ...
  *Variable: antiArythMedsSelf;
  antiArythMedsSelf = .;
  if antiArythMedsSelfRep = 2 then antiArythMedsSelf = 0;
  if antiArythMedsSelfRep = 1 then antiArythMedsSelf = 1;
